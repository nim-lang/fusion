...
var NNI654311433 = {kind: 2, len: 2, offset: 0, typ: null, name: null, sons: [{kind: 1, offset: "Field0", len: 0, typ: NTI33554450, name: "Field0", sons: null}, 
...
function nimBoolToStr(x_33556431) {
  var result_33556432 = [];

    if (x_33556431) {
    result_33556432 = nimCopy(null, [116,114,117,101], NTI33554449);
    }
    else {
      result_33556432 = nimCopy(null, [102,97,108,115,101], NTI33554449);
    }
...
function auxWriteStackTrace_33556501(f_33556502) {
  var result_33556503 = [[]];
    ...
    Label5: {
      var j_33556544 = 0;
      var colontmp__654311527 = 0;
      colontmp__654311527 = (i_33556512 - 1);
      var res_654311529 = colontmp__654311527;
      Label6: {
          Label7: while (true) {
          if (!(0 <= res_654311529)) break Label7;
            j_33556544 = res_654311529;
  ...
  framePtr = F;
    ...
    Label2: {
      ...
      Label3: {
        F.line = 129;
          Label4: while (true) {
          if (!(i_654311522 < n_301990092)) break Label4;
            F.line = 50;
            F.filename = "digitsutils.nim";
            iHEX60gensym4_301990107 = i_654311522;
            F.line = 50;
            ...
            F.line = 131;
            F.filename = "iterators_1.nim";
            i_654311522 = addInt(i_654311522, 1);
          }
      };
    };
  framePtr = F.prev;
...
var F = {procname: "module jsxmlhttprequest_examples_1", prev: framePtr, filename: "/home/runner/work/fusion/fusion/fusion/htmldocs/nimcache/runnableExamples/jsxmlhttprequest_examples_1.nim", line: 0};
framePtr = F;
if (false) {
F.line = 39;
F.filename = "jsxmlhttprequest.nim";
var request_654311428 = new XMLHttpRequest();
F.line = 39;
request_654311428.open("GET", "http://localhost:8000/", false, null, null);
F.line = 39;
request_654311428.setRequestHeader("mode", "no-cors");
F.line = 39;
(() => { const rqst = request_654311428; [nimCopy(null, {Field0: "mode", Field1: "no-cors"}, NTI654311433)].forEach((item) => rqst.setRequestHeader(item[0], item[1])) })();
F.line = 39;
request_654311428.overrideMimeType("text/plain");
F.line = 39;
request_654311428.send(null);
F.line = 39;
rawEcho(cstrToNimstr(request_654311428.getAllResponseHeaders()));
F.line = 39;
rawEcho([114,101,115,112,111,110,115,101,84,101,120,116,9], cstrToNimstr(request_654311428.responseText));
F.line = 39;
rawEcho([114,101,115,112,111,110,115,101,85,82,76,9], cstrToNimstr(request_654311428.responseURL));
F.line = 39;
rawEcho([115,116,97,116,117,115,84,101,120,116,9], cstrToNimstr(request_654311428.statusText));
F.line = 39;
rawEcho([114,101,115,112,111,110,115,101,88,77,76,9], [116,114,117,101]);
F.line = 39;
rawEcho([115,116,97,116,117,115,9], HEX24_369098760(((request_654311428.status) | 0)));
F.line = 39;
rawEcho([116,105,109,101,111,117,116,9], HEX24_369098760(((request_654311428.timeout) | 0)));
F.line = 39;
rawEcho([119,105,116,104,67,114,101,100,101,110,116,105,97,108,115,9], nimBoolToStr(request_654311428.withCredentials));
F.line = 39;
rawEcho([114,101,97,100,121,83,116,97,116,101,9], HEX24_369098760(((request_654311428.readyState) | 0)));
F.line = 39;
request_654311428.abort();
}
