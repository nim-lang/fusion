...
function escapeCString_402653842(x_402653843, x_402653843_Idx) {
    ...
    L1: do {
      var c_402653845 = 0;
      var i_402654051 = 0;
      var L_402654052 = ((x_402653843[x_402653843_Idx]) == null ? 0 : (x_402653843[x_402653843_Idx]).length);
      L2: do {
          L3: while (true) {
          if (!(i_402654051 < L_402654052)) break L3;
            c_402653845 = x_402653843[x_402653843_Idx].charCodeAt(chckIndx(i_402654051, 0, (x_402653843[x_402653843_Idx]).length-1));
            switch (c_402653845) {
            case 60:
